...
## Описание
Использовал две команды, потому что не нашел решения для сбора информации с локального и удаленных хостов одной командой без использования файла с inventory.  
